...
import {} from '@/components/portfolio/positions-table'
...
import { BarChart3, List, Download, TrendingUp, TrendingDown, Plus, Share2, Globe, Lock, Check, Copy, History, Receipt } from 'lucide-react'
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Link href={`/portfolio/${id}/costs`} className={cn(buttonVariants({ variant: 'outline', size: 'sm' }), 'rounded-xl')}><Receipt aria-hidden="true" className="h-4 w-4 mr-1" /> Costos</Link>
